...
function currentChromePluginAppServerSourceBundleFixture() {
  return [
    ...
    "async function cq(e){let t=[...new Set([...e.extensionIds,...nb(e.nativeHostName)])],n=Aq(),r=await kq({pluginRoot:e.pluginRoot,target:n});return{extensionIds:t,target:n,extensionHostPath:r}}",
    "function nb(){return[]}function Aq(){return{platform:`linux`,architecture:`x64`,filename:`extension-host`}}async function kq(e){return e.pluginRoot}",
