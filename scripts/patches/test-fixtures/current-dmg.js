...
function currentChromePluginAppServerSourceBundleFixture() {
  return [
    ...
    "function nb(){return[]}function Aq(){return{platform:`linux`,architecture:`x64`,filename:`extension-host`}}async function kq(e){return i.join(e.pluginRoot,`extension-host`,`linux`,`x64`,`extension-host`)}",
