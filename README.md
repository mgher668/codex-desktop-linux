...
| Linux Computer Use backend | Bundled | MCP backend registers by default; window targeting supports GNOME, KWin/Plasma, Hyprland, COSMIC, niri, and i3 | [Linux Computer Use](docs/linux-computer-use.md) |
